...
public class Publish {
    public func pushFir(outputLog: String = "更新日志", ipaPath: String, bundleID: String, name: String, version: String, apiToken: String) {
    ...
    public func pushPgyer(outputLog: String = "更新日志", ipaPath: String, pgyerAPIKey: String, password: String = "") {
